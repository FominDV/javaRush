...
public class Solution {
    ...
    public static void main(String[] args) {
        try {
           ...
           if(exception instanceof FileNotFoundException) System.out.println(FAILED_TO_READ);
            if(exception instanceof FileSystemException) System.out.println(FAILED_TO_WRITE);
        }
    }
}
