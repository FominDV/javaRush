...
public class Solution {
    ...
    public static void checkElementsType(ArrayList<Object> elements) {
        for(Object object:elements){
            if(object instanceof String){ printString();continue;}
            if(object instanceof Integer) {printInteger();continue;}
            if(object instanceof Integer[]){ printIntegerArray();continue;}
            printUnknown();
        }
