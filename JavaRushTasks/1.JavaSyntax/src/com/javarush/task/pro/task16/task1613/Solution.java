...
public class Solution {
    ...
    public static boolean isWeekend(LocalDateTime dateTime) {
        var dayOdWeek=dateTime.getDayOfWeek().getValue();
        var hour=dateTime.getHour();
        if(dayOdWeek==SATURDAY||(dayOdWeek==FRIDAY&&hour>=WEEKEND_START_FRIDAY_CUT_OFF_HOUR)||(dayOdWeek==SUNDAY&&hour<WEEKEND_END_SUNDAY_CUT_OFF_HOUR)) return true;
        else return false;
