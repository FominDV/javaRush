...
public class Solution {
    ...
    public static long[] getNumbers(long N) {
        ...
        for (int i = 1; i < N; i++) {
            ...
            divisionNumber = 10;
            buff=i;
            while (( buff / divisionNumber) != 0) {
                S++;
                //buff-=buff % divisionNumber;
                divisionNumber *= 10;
            }
            newNumber=0;
            divisionNumber=10;
            buff=i;
            for (int j = 0; j <S ; j++) {
                newNumber+=Math.pow(buff%divisionNumber,S);
                buff-=buff%divisionNumber;
                buff/=divisionNumber;
                //divisionNumber*=10;
            }
            if(i==newNumber) list.add(Long.valueOf(i));
        }
    ...
    public static long[] getNumbers1(long upperLimit) {
